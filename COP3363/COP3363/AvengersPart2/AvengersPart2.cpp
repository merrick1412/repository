...
void createCumulativeTotalEachRange(int numAppearances[NUM_AVENGERS],int cumulativeTotalEachRange[6]);
void displaySortedTotals(int numAppearances[NUM_AVENGERS]);
...
int main()
{
    ...
    while (true) //loop for menu selection
    {
        ...
        switch (switchChoice) //switch loop for menu selection
        {
            ...
            case '4' :
                displaySortedTotals(numAppearances); //calls a function to display the sorted totals
                break;
...
void displaySortedTotals(int numAppearances[NUM_AVENGERS]) //function for displaying the sorted totals
{
    ...
    createCumulativeTotalEachRange(numAppearances, cumulativeTotalEachRange); //calls the function that puts the cumulative totals into the array
...
void createCumulativeTotalEachRange(int numAppearances[NUM_AVENGERS],int cumulativeTotalEachRange[6]) //function for finding the cumulative totals
{
    int i;
